...
> **Warning**
> if you want to use janus 0.x please visit here repo [janus-webrtc-gateway-docker-0.x](https://github.com/atyenoria/janus-webrtc-gateway-docker)
> 如果你想使用janus 0.x版本的话请访问 [janus-webrtc-gateway-docker-0.x](https://github.com/atyenoria/janus-webrtc-gateway-docker) 这个仓库
> 当前仓库的版本都是janus 1.0 版本之后的 。
## janus 1.x
